...
Files uploaded to DumbLoad were disappearing when using Docker bind mounts (e.g., `-v ./uploads:/app/uploads`). The application only worked correctly with named Docker volumes.
...
- [d69a8b2](https://github.com/BenGhosti/DumbLoad/commit/d69a8b25b4008f0a5f037ae56d9647651554af11) - Previous attempt (caused the issue)
- [fc8bff9](https://github.com/BenGhosti/DumbLoad/commit/fc8bff9a1422004d159e19bd5c698da77536a62f) - Related security improvements
